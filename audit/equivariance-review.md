# Review notes: the C*-equivariance claims and sheet parametrization

**Summary: both claim-sets confirmed** ( one scoping caveat on the image
corollary, one wording requirement on the lifting law; see the addendum).

Scope note: this report covers the
equivariance claim-set and the later-added sheet-parametrization claims.

- Reviewer: a separate session, 2026-07-20.
- Script: `/home/alex/code/jc/audit/equivariance_checks.py`: written from scratch,
...
## Additional facts verified along the way
...
**Confirmed, and upgraded to a complete proof of the lifting law.**
Script: `/home/alex/code/jc/audit/wall_identity_check.py` (23/23 PASS, exact
