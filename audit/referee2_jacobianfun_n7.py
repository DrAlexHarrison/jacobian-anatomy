#!/usr/bin/env python3
"""
REFEREE-2 spot-check of the jacobianfun uniform-in-n construction at n = 7
(d = 6), a value beyond ORCH's verified n = 3, 4, 5. Builds F_7 from their
...
print()
print("REFEREE-2 n=7 SPOT-CHECK: ALL PASS — uniform-in-n recipe verified at a")
print("value beyond ORCH's n=3,4,5 instances; analytic referee in inbox-vetter.")
