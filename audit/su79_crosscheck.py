#!/usr/bin/env python3
"""
Second implementation of the SU(79) Mathieu computations
layer (public copy: mathieu-su79/su79_certificate.py). Written from scratch
own script, exact arithmetic, no code
...
log("        (identical det==1 on all of C^79: druzkowski symbolic proof, "
    "proved separately; spot-checks here are the consumption check)")
...
print()
if FAILURES:
    print("crosscheck failures:", FAILURES)
    sys.exit(1)
print("crosscheck: all checks pass")
...
print("  controls). The representation-theoretic bridge is reviewed separately")
print("  in audit/su79-review.md (report), not by this script.")
